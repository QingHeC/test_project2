...
function add_tables_formdata(obj,inde) {
    ...
    cellname_check3.innerHTML="<td size='' bgcolor='#FFFFFF' ><select type='' onchange='upd_text_file(this)' width='14px' value='' size='' style='width: 100%;'><option value='text'>text</option><option value='file'>file</option></select></td>";
...
//     tr.cells[0].innerHTML = tr.cells[0].childNodes[0].value
    ...
    tr.cells[1].innerHTML = "<td size='40' bgcolor='#FFFFFF'><input type='text' style='height: 24px;' value='" + tr.cells[1].innerHTML +"' size='40'/></td>";
    ...
    if(tr.cells[2].childNodes[0].value == 'file' || tr.cells[2].childNodes[0].textContent == 'file'){
            tr.cells[2].innerHTML = "<td size='' bgcolor='#FFFFFF'>" +
        "<select type='' onchange='upd_text_file(this)' style='width:100%;' value='" + tr.cells[2].innerHTML +"' size=''>" +
    ...
    tr.cells[2].innerHTML = "<td size='' bgcolor='#FFFFFF'>" +
        ...
        tr.cells[3].innerHTML = "<td size='40' bgcolor='#FFFFFF'><input type='text'style='height: 24px;' value='" + tr.cells[3].innerHTML +"'  width='20px' size='40'/></td>";
     }
...
function add_tables_assert(tab_t,index_s) {
    ...
    cellname_value1.innerHTML= "<td  width='10' editstate='true' bgcolor='#FFFFFF'>" +
        "<select type='' onchange='upd_assert(this)' width='12px' value='' size='' style='width: 100%;' >" +
        op_text +
        "</select></td>";
    ...
    cellname_value3.innerHTML="<td  width='15' editstate='true' bgcolor='#FFFFFF'>" +
        "<select type='' onchange='upd_assert(this)' width='12px' value='' size='' style='width: 100%;'>" +
...
function update_tables_assert(obj) {
    ...
    var tb1=document.getElementById("tab_req_assert");
    ta_data = tb1.rows[0].cells[1].attributes["dataitems"].value;
    data_items = eval("["+ta_data+"]");
    console.log(data_items);
    // data_items = document.querySelector("#tab_req_assert>tbody>tr[1]>th[2]").attributes["DataItems"];
    // console.log(data_items);
    var tr = obj.parentNode.parentNode; // 获取的本行的tr
	// alert(tr.cells[2].childNodes[0].textContent)
//     tr.cells[0].innerHTML = tr.cells[0].childNodes[0].value
    ...
    for(var i=0; i< data_items.length;i++){
        for (var dat_key in data_items[i]) {
            console.log(data_items[i][dat_key]);
            if (data_items[i][dat_key] == tr.cells[1].childNodes[0].textContent){
                op_text += "<option selected='selected' style='width: 100%;' value="+ dat_key +">" + data_items[i][dat_key] +"</option>";
            }else {
                op_text += "<option   style='width: 100%;' value="+ dat_key +">" + data_items[i][dat_key] +"</option>";
            }
        }
    ...
    tr.cells[1].innerHTML= "<td  width='10' editstate='true' bgcolor='#FFFFFF'>" +
        "<select type='' value=''  style='width: 100%;' size='' >" +
        op_text +
        "</select></td>";

    tr.cells[2].innerHTML = "<td bgcolor='#FFFFFF'><input size='40' type='text' style='height: 24px;' value='" + tr.cells[2].innerHTML +"'/></td>";
    ...
    for(var lis=0;lis <cell3_data.length;lis++){
        if(cell3_data[lis]['value'] == tr.cells[3].childNodes[0].textContent){
            cell_option += "<option selected='selected' style='width: 100%;' value="+ cell3_data[lis]['value'] +">" + cell3_data[lis]['text'] +"</option>";
        }else {
            cell_option += "<option   style='width: 100%;' value="+ cell3_data[lis]['value'] +">" + cell3_data[lis]['text'] +"</option>";
        }
    }


    tr.cells[3].innerHTML = "<td  width='10' editstate='true' bgcolor='#FFFFFF'>" +
        "<select type=''  style='width: 100%;'  value='' size='' >" +
            cell_option +
        "</select></td>";

    tr.cells[4].innerHTML = "<td bgcolor='#FFFFFF'><input size='40' type='text' style='height: 24px;' value='" + tr.cells[4].innerHTML + "'/></td>";
